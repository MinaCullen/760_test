...
def plot_confusion_matrix(confusion_matrix,
    ...
    filehandler = open(b"work_dirs/frozen_final/conf_mat.pkl","wb")
    pickle.dump(confusion_matrix, filehandler)
...
def main():
    sys.argv = ["confusion.py", "configs/wsod/faster_rcnn_r50_argoverse.py", "work_dirs/frozen_final/preds.pkl", "work_dirs/frozen_final"]
    args = parse_args()
